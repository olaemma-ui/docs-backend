...
__decorate([
    (0, typeorm_1.Column)({ enum: user_enums_1.AccountStatus, default: user_enums_1.AccountStatus.PENDING }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.Column)({ default: user_enums_1.UserRoles.USER, enum: user_enums_1.UserRoles }),
    __metadata("design:type", String)
