        ...
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: async (config) => ({
                    type: 'postgres',
                    host: config.get('LOCAL_POSTGRES_HOST', 'LOCALhost'),
                    port: parseInt(config.get('LOCAL_POSTGRES_PORT', '5432'), 10),
                    username: config.get('LOCAL_POSTGRES_USER', 'postgres'),
                    password: config.get('LOCAL_POSTGRES_PASSWORD', ''),
                    database: config.get('LOCAL_POSTGRES_DB', 'app_db'),
